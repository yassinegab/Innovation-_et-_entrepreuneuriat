    ...
    if (isset($_POST['verification_type_Btn'])) {
        ...
        if ($method === 'email') {
          $emailvalue=$_POST["verification_method_value"];
            sendPasswordResetEmail($emailvalue, $code);
...
$phone = "+21628613052"; // Example: +14151234567
$apikey = "1973497";     // You got this from CallMeBot
...
<body>
    <div class="container">
        ...
        <form action="#" method="post">
            ...
            <label class="option">
                <div>
                    <div class="option-label">enter your email or phone number</div>
                    <div class="option-desc">We'll send an SMS with a code to your registered phone</div>
                    <input type="text" name="verification_method_value" value="phone">
                </div>
            </label>
            
            <button type="submit" name="verification_type_Btn">Continue</button>
        </form>
    </div>
</body>
</html>
...
function sendPasswordResetEmail($to, $code) {
  ...
  $mail = new PHPMailer();
    ...
    try {
        ...
        // Recipients
        $mail->setFrom('stelliferous@gmail.com', 'STELLIFEROUS ACCOUNT login confirm');
        $mail->addAddress($to);

        // Content
        $mail->isHTML(true);
$mail->Subject = 'STELLIFEROUS TEAM HERE $code - this is your login confirmation code ';
...
$mail->Body = "
    ...
    <div style='font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;'>
        <div style='max-width: 600px; margin: auto; background: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);'>
            ...
            <p style='font-size: 16px; color: #555555;'>We received a request to reset your Stelliferous account password. Here's your login confirmation code:</p>
