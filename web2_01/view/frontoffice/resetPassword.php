...
<body>
  <div class="auth-container">
    ...
    <form method="POST">
      ...
      <button type="submit" name="emailBtn">Envoyer</button>
    </form>

    <?php if ($showMessage): ?>
        <?php if ($emailExist): ?>
            <p style="color: red;">this email doesnt exist, try to use valid email</p>
        <?php else: ?>
            <p style="color: red;">Cet e-mail n'existe pas dans notre système.</p>
        <?php endif; ?>
    <?php endif; ?>
  </div>
</body>
