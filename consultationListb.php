                ...
                <div class="header-right">
                    ...
                    <div class="header-actions">
                        ...
                        <div class="user-profile">
                            <img src="8 (7).jpg" alt="Admin User">
                            <div class="user-info">
                                <span class="user-name">takoua</span>
                ...
                <div class="controls-wrapper">
                    <div class="control-item">
                        ...
                        <div class="control-body">
                            <form method="GET" action="" class="search-form">
                                <input type="number" name="search_id" class="search-input" placeholder="Entrez l'ID..." 
                    ...
                    <div class="control-item">
                        ...
                        <select class="sort-select" onchange="window.location = this.value;">
                            <option value="?sort=id_asc" <?= (isset($_GET['sort']) && $_GET['sort'] == 'id_asc') ? 'selected' : '' ?>>ID (croissant)</option>
                            <option value="?sort=id_desc" <?= (isset($_GET['sort']) && $_GET['sort'] == 'id_desc') ? 'selected' : '' ?>>ID (décroissant)</option>
                            <option value="?sort=titre_asc" <?= (isset($_GET['sort']) && $_GET['sort'] == 'titre_asc') ? 'selected' : '' ?>>Titre (A-Z)</option>
                            <option value="?sort=titre_desc" <?= (isset($_GET['sort']) && $_GET['sort'] == 'titre_desc') ? 'selected' : '' ?>>Titre (Z-A)</option>
                        </select>
...
--pastel-purple: #9B59B6;
        ...
        .control-item:hover {
            border-color: rgba(227, 196, 58, 0.2);
            box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);
        }
