...
<head>
    ...
    <title>Projets Entrepreneuriaux - EntrepreHub</title>
...
<?php foreach ($liste as $project) { ?>
    <div class="project-card">
    <div class="project-header">
        <div class="project-logo" style="background-color: rgba(33, 150, 243, 0.1);">
            <span><?= strtoupper(substr($project['nom_projet'], 0, 2)) ?></span>
        </div>
    </div>
        <h3>ID : <?= $project['id_projet'] ?></h3>
        <h3>Nom : <?= htmlspecialchars($project['nom_projet']) ?></h3>
        <p>Description : <?= htmlspecialchars($project['descriptionn']) ?></p>
        <p>Domaine : <?= htmlspecialchars($project['domaine']) ?></p>
        <p>Date de création : <?= htmlspecialchars($project['date_creation']) ?></p>
        <p>Besoins : <?= htmlspecialchars($project['besoin']) ?></p>

        <div style="margin-top: 10px;">
        <?php if ($user_id == 1): ?>
      <a href="update_project.php?id_projet=<?= $project['id_projet'] ?>&user_id=<?= $user_id ?>">Modifier</a>
      <a href="projects-front.php?delete_id=<?= $project['id_projet'] ?>&user_id=<?= $user_id ?>">Supprimer</a>
    <?php endif; ?>
        </div>
    </div>
<?php } ?>
        ...
        <footer class="site-footer">
            <div class="container">
                ...
                <div class="footer-bottom">
                    <p>&copy; 2025 EntrepreHub. Tous droits réservés.</p>
