...
{  
  ...
  propositionCards.forEach(card => {
        ...
        if (cardType.includes(event.target.value.toLowerCase())) {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function openForm() {
  document.querySelector('.overlaymoez2').classList.add('active');
  
}

function closeForm() {
  document.querySelector('.overlaymoez2').classList.remove('active');
