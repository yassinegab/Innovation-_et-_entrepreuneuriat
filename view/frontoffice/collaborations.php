        ...
        <section class="section fade-in delay-2">
            ...
            <div class="table-container">
                <table>
                    ...
                    {$user=$userdhia->load_user($colllaborationn['collaborateur_id']);
                        ...
                        <tr>
                            <td>
                                <div class="collaborator">
                                    <div class="collaborator-info">
                                        <div class="collaborator-name"><?= $user->getLastName().' '.$user->getName() ?></div>
                                        <div class="collaborator-email"><?= $user->getEmail() ?></div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    <a href="collaborations.php?idsupp=<?=$colllaborationn['id_collaboration']?>" class="action-btn cancel" title="Annuler la collaboration" onclick="openCancelModal('<?= $user->getLastName().' '.$user->getName() ?>')">❌</a>
                                </div>
                            </td>
                        </tr>
                    <?php }?>    
