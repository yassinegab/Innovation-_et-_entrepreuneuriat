            ...
            <li class="sidebar-menu-item">
                ...
                <ul class="submenu">
                    <li class="submenu-item">
                        <a href="#" class="submenu-link" class="fas fa-list-ul"> <i class="fas fa-list-ul"></i>   Propositions</a>
                    </li>
                    <li class="submenu-item">
                        <a href="#" class="submenu-link" class="fas fa-handshake"> <i class="fas fa-handshake"></i>Collaborations</a>
                    </li>
