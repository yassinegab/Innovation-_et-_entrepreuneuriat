...
<?php foreach ($liste as $project) { ?>
    <div class="project-card">
        ...
        <div class="project-content">
            <h3 class="project-title"><?= htmlspecialchars($project['nom_projet']) ?></h3>
            <p class="project-description"><?= htmlspecialchars($project['descriptionn']) ?></p>
            <div class="project-meta">
                <div class="project-category"><?= htmlspecialchars($project['domaine']) ?></div>
            </div>
            <div class="project-info">
                <p><strong>Date :</strong> <?= htmlspecialchars($project['date_creation']) ?></p>
                <p><strong>Besoins :</strong> <?= htmlspecialchars($project['besoin']) ?></p>
            </div>
        </div>
        <div class="project-footer">
            <a href="update_project.php?id_projet=<?= $project['id_projet'] ?>" class="btn btn-sm btn-text">Modifier</a>
            <a href="back_projet.php?delete_id=<?= $project['id_projet'] ?>" class="btn btn-sm btn-text">Supprimer</a>
        </div>
    </div>
<?php } ?>
</div>
