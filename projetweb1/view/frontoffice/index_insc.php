                ...
                <nav class="nav">
                    ...
                    <ul class="nav-menu">
                       <li><a href="#home" class="active">Accueil</a></li>
                        ...
                        <li><a href="/intg/produittt/view/frontoffice/projects-front.php">projets</a></li>
            ...
            <div class="container">
                <div class="section-header">
                    <h2>Nos Événements</h2>
                       <a href="index.php" class="wanna-subscribe-btn">back to events</a>
...
<div class="events-grid">
    <?php if (!empty($listeEvenements) && (is_array($listeEvenements) || is_object($listeEvenements))): ?>
        <?php foreach ($listeEvenements as $evenement): 
           $estInscrit = estDejaInscrit($evenement['id_ev'], $listeInscriptions, $id_utilisateur);
        ...
        if ($estInscrit) {
    foreach ($listeInscriptions as $inscription) {
        if ($inscription['id_eve'] == $evenement['id_ev'] && $inscription['id_uti'] == $id_utilisateur) {
