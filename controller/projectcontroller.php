...
public function addproject($project) {
    $sql = "INSERT INTO projet (id_projet, nom_projet, descriptionn, domaine, date_creation, besoin)
            VALUES (:id_projet, :nom_projet, :descriptionn, :domaine, :date_creation, :besoin)";
