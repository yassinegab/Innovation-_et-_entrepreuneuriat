...
public function addproject($project) {
    $sql = "INSERT INTO projet (nom_projet, descriptionn, domaine, date_creation, besoin, id_user)
        VALUES (:nom_projet, :descriptionn, :domaine, :date_creation, :besoin, :id_user)";
    ...
    try {
        ...
        $query->bindValue(':id_user', $project->get_id_user());
