...
class EvenementController {
    ...
    public function addEvenement($evenement) {
        try {
            $query = "INSERT INTO evenement (nom, date, lieu, capacite, categorie, prix, espace_fumeur, accompagnateur_autorise,image) 
                      VALUES (:nom, :date, :lieu, :capacite, :categorie, :prix, :espace_fumeur, :accompagnateur_autorise,:image)";
    ...
    public function updateven($id, $nom, $date, $lieu, $capacite, $categorie = null, $prix = 0, $espace_fumeur = 0, $accompagnateur_autorise = 0,$image=NULL) {
        try {
            $query = "UPDATE evenement 
                      SET nom = :nom, date = :date, lieu = :lieu, capacite = :capacite, 
                          ...
                          accompagnateur_autorise = :accompagnateur_autorise, image = :image
                      WHERE id_ev = :id";
